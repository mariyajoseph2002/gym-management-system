    ...
    <div class="container py-lg-5 py-md-4">
        <div class="row">
            <div class="col-lg-6 mb-lg-0 mb-md-5 mb-4">
                ...
                <p class="mt-3 mb-0">  Our gym provides a platform to improve your health,fitness etc. So this is a platform which will solve your problems.<b>Start a change</b></p>
        ...
        <div class="container">
            <div class="row aboutblock2-info-inn mx-lg-0">
                ...
                <div class="col-lg-4 aboutblock-left">
                    <img src="adminthings/gym2.jpg" class="img-fluid radius-image" alt="">
                </div>
                <div class="col-lg-4 aboutblock-right">
                    <div class="row aboutblock-right-grids mb-md-5 mb-4">
                        <div class="col-2 aboutblock-right-icon">
	...
	<div class="middle py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="welcome-left text-center py-md-3">
                ...
                <a href="classes.php" class="btn-style btn-primary btn mt-lg-5 mt-4">View services</a>
			</div>
		</div>
	</div>
	<!-- //middle -->
