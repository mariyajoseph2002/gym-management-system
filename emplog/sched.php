							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<input class="btn btn-sm btn-outline-primary edit_sch"  href="javascript:void(0)" type="submit" data-sch_id="<?php echo $row['sch_id'] ?>" value
										="Edit" ></input>
									</td>
									</tr>
								<?php endwhile; ?>
...
// 	$save = mysqli_query($conn,"INSERT INTO tbl_schedule(sch_slot) VALUES('$sch_slot'");
// }
// else
// echo "y";
?> -->