      ...
      <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav ml-auto">
                  ...
                  </li><li class="nav-item @@about__active">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 item">
                <div class="card">
                    <div class="card-header p-0 position-relative">
                        <a href="#blog-single">
                            <img class="card-img-bottom d-block" src="assets/images/blo5.jpg" alt="Card image cap">
                        </a>
            ...
            <div class="col-lg-4 col-md-6 item mt-md-0 mt-5">
                <div class="card">
                    <div class="card-header p-0 position-relative">
                        <a href="#blog-single">
                            <img class="card-img-bottom d-block" src="assets/images/blog6.jpg" alt="Card image cap">
                        </a>
                        <ul class="location-top">
                            <li class="tip">Weightloss</li>
                        </ul>
                    </div>
                    <div class="card-body class-details">
                        <a href="#blog-single" class="blog-desc">Weightloss Classes
                        </a>
                        <p class="mt-3"><span class="lnr lnr-clock"></span> <strong>Mon - Fri</strong> : 7am to 9pm</p>
                        <p class="mt-1"><span class="lnr lnr-clock"></span> <strong>Sat - Sun</strong> : 10 am to 8 pm
                        </p>
            ...
            <div class="col-lg-4 col-md-6 item mt-lg-0 mt-5">
                <div class="card">
                    <div class="card-header p-0 position-relative">
                        <a href="#blog-single">
                            <img class="card-img-bottom d-block" src="assets/images/blo1.jpg" alt="Card image cap">
                        </a>
                        <ul class="location-top">
                            <li class="design">CrossFit</li>
                        </ul>
                    </div>
                    <div class="card-body class-details">
                        <a href="#blog-single" class="blog-desc"> CrossFitClasses
                        </a>
                        <p class="mt-3"><span class="lnr lnr-clock"></span> <strong>Mon - Fri</strong> : 7am to 9pm</p>
                        <p class="mt-1"><span class="lnr lnr-clock"></span> <strong>Sat - Sun</strong> : 10 am to 8 pm
                        </p>
            ...
            <div class="col-lg-4 col-md-6 item mt-md-0 mt-5">
                <div class="card">
                    <div class="card-header p-0 position-relative">
                        ...
                        <ul class="location-top">
                            <li class="tip">Cardio</li>
                        </ul>
                    </div>
                    <div class="card-body class-details">
                        <a href="#blog-single" class="blog-desc">Cardio Classes
                        </a>
                        <p class="mt-3"><span class="lnr lnr-clock"></span> <strong>Mon - Fri</strong> : 7am to 9pm</p>
                        <p class="mt-1"><span class="lnr lnr-clock"></span> <strong>Sat - Sun</strong> : 10 am to 8 pm
                        </p>
    ...
    <div class="container py-lg-5 py-md-4">
        <div class="row">
            <div class="col-lg-6 mb-lg-0 mb-md-5 mb-4">
                ...
                <p class="mt-4 mb-0">  Our gym provides a platform to improve your health,fitness etc. So this is a platform which will solve your problems.<b>Start a change</b></p>
                <a href="registration.php" class="btn-style btn-primary btn mt-lg-5 mt-4">Join Now</a>
            </div>
            <div class="col-lg-6">
       ...
       <div class="footers20-content">
         <div class="d-grid grid-col-4 grids-content">
           ...
           <div class="column">
             ...
             <a href="mailto:km@gmail.com.com">
