...
<div class="container-fluid">
	...
	<div class="col-lg-12">
		<div class="row">
			<!-- FORM Panel -->
			<div class="col-md-4">
			<form method="POST" action="" id="manage-plan">
				<div class="card">
...
<form> 			<!-- <input class="btn btn-primary" type="submit" id="add" name="edit" value="Edit"> -->		</form>				
</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
if(isset($_POST['create'])){
	...
	$price=$_POST['price'];
	if(mysqli_query($conn,"INSERT INTO tbl_service(ser_name,duration,price,Emp_ID) VALUES('$ser_name','$duration','$price','$id')"))
	{
		echo "yes";
	}
	else
