                            ...
                            <div class="card">
                                <div class="card-body bg-primary">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                          <?php echo $conn->query("SELECT * FROM tbl_customer ")->num_rows; ?> 
                                        </b></h4>
                            ...
                            <div class="card">
                                <div class="card-body bg-info">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM tbl_trainer")->num_rows; ?>
                                        </b></h4>
                            ...
                            <div class="card">
                                <div class="card-body bg-warning">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM tbl_service")->num_rows; ?>
                                        </b></h4>
                                        <p><b>Total Services</b></p>
                                    </div>
                                </div>
                            </div>
                        </div>
